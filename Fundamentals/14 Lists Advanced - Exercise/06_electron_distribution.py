...
# The basic idea of electron distribution is that electrons should fill a shell until
# it holds the maximum number of electrons.
...
numbers = int(input())
print(electron_distribution(numbers))
